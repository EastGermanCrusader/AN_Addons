-- eastgermancrusader_cff/lua/weapons/sw_artillery_binocular/shared.lua
-- Artillerie Binocular
-- OPTIMIERT für Mehrspieler

AddCSLuaFile()

SWEP.Base = "weapon_base"
SWEP.Category = "EastGermanCrusader"  -- Angepasst an deine Base
SWEP.Author = "EastGermanCrusader"
SWEP.PrintName = "Artillerie Binocular"
