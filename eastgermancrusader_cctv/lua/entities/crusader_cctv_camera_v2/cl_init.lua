-- eastgermancrusader_cctv/lua/entities/crusader_cctv_camera_v2/cl_init.lua
-- ============================================
-- OPTIMIERTE CLIENT-SEITIGE KAMERA V2 RENDERING
-- Identisch mit V1 Client-Code
-- ============================================
...
function ENT:Draw()
    ...
    -- OPTIMIERT: Effekte nur wenn nah genug
