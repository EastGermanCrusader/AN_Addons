...
function ENT:LaunchMissile(target, torpedoType)
    ...
    torpedoType = torpedoType or 0  -- 0 = Spreng, 1 = Ionen (EMP)
    ...
    -- Torpedo-Art setzen (vor Enable)
    torpedo:SetTorpedoType(torpedoType)
